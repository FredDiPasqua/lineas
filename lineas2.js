...
var interdraw1 = () => drawsaved(save1);
var interdraw2 = () => drawsaved(save2);
var interdraw3 = () => drawsaved(save3);
var interdraw4 = () => drawsaved(save4);
var interdraw5 = () => drawsaved(save5);
var interdraw6 = () => drawsaved(save6);
var interdraw7 = () => drawsaved(save7);
var interdraw8 = () => drawsaved(save8);
var interdraw9 = () => drawsaved(save9);
...
function savedibujo (cond) {
    ...
    if (cond == "A"){
        ...
        while (init1 == 0) {
            ...
            init1++;
            btnsketch1.addEventListener("click", interdraw1);
    ...
    if (cond == "S") {
        ...
        while (init2 == 0) {
            ...
            init2++;
            btnsketch2.addEventListener("click", interdraw2);
        }
    ...
    if (cond == "D") {
        ...
        while (init3 == 0) {
            ...
            init3++;
            btnsketch3.addEventListener("click", interdraw3);
        }
    ...
    if (cond == "F") {
        ...
        while (init4 == 0) {
            ...
            init4++;
            btnsketch4.addEventListener("click", interdraw4);
        }
    ...
    if (cond == "G") {
        ...
        while (init5 == 0) {
            ...
            init5++;
            btnsketch5.addEventListener("click", interdraw5);
        }
    ...
    if (cond == "H") {
        ...
        while (init6 == 0) {
            ...
            init++;
            btnsketch6.addEventListener("click", interdraw6);
        }
    ...
    if (cond == "J") {
        ...
        while (init7 == 0) {
            ...
            init7++;
            btnsketch7.addEventListener("click", interdraw7);
        }
    ...
    if (cond == "K") {
        ...
        while (init8 == 0) {
            ...
            init8++;
            btnsketch8.addEventListener("click", interdraw8);
        }
    ...
    if (cond == "L") {
        ...
        while (init9 == 0) {
            ...
            init9++;
            btnsketch9.addEventListener("click", interdraw9);
        }
